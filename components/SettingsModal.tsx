...
export default function SettingsModal({ apiKeys, provider, model, onSave, onClose }: Props) {
      ...
      <div className="bg-[#1e1e1e] border border-[#3f3f3f] rounded-xl w-full max-w-md shadow-2xl">
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-gray-600">Keys are stored locally in your browser only.</p>
          </div>
        </div>
